...
import 'package:easybuyer/screens/Wallet/addMoney_page.dart';
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  border: Border.all(color: Color(0xff966f33))),
              child: Center(
                child: Text(
                  "₹",
                  style: TextStyle(color: Color(0xff966f33)),
                ),
              ),
            ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                border: Border.all(color: Color(0xff966f33)),
                color: selectedIndex == index ? Color(0xff966f33) : Colors.white,
              ),
